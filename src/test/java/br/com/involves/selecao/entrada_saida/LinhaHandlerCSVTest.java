...
public class LinhaHandlerCSVTest {
    ...
    public void testarCabecalhoComUmParametro() throws EntidadeDeLeituraException {
        String conteudo = "p1";
        Cabecalho cabecalho = getEntidadeCabecalho(conteudo);
    ...
    public void testarMultiplasLeituras() throws EntidadeDeLeituraException {
        ...
        Propriedades entidade1 = getEntidadeComPropriedades(conteudoLinha1);
        ...
        Propriedades entidade2 = getEntidadeComPropriedades(conteudoLinha2);
    ...
    private Propriedades getEntidadeComPropriedades(String conteudo) throws EntidadeDeLeituraException {
        EntidadeDeLeitura entidadeDeLeitura = linhaHandlerCSV.lidarCom(conteudo);
        Assert.assertTrue(entidadeDeLeitura instanceof Propriedades);
        return (Propriedades) entidadeDeLeitura;
    }

    private Cabecalho getEntidadeCabecalho(String conteudo) throws EntidadeDeLeituraException {
        EntidadeDeLeitura entidadeDeLeitura = linhaHandlerCSV.lidarCom(conteudo);
        Assert.assertTrue(entidadeDeLeitura instanceof Cabecalho);
        return (Cabecalho) entidadeDeLeitura;
    }
